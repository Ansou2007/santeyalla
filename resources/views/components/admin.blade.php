        ...
        <ul>
            ...
            <li class="submenu">
                <a href="#"><i class="fas fa-graduation-cap"></i> <span>Ventilation</span> <span
                        class="menu-arrow"></span></a>
                <ul>
                    <li><a href="{{route('Ventilation.ajout')}}"
                            class="{{request()->routeIs('Ventilation.ajout') ? 'active':''}}"><i
                                class="fas fa-plus"></i>Ajouter Ventilation</a></li>
                    <li><a href="{{route('Ventilation.index')}}"
                            class="{{request()->routeIs('Ventilation.index') ? 'active':''}}"><i
                                class="fas fa-book"></i>Liste Ventilation</a></li>
                    {{-- <li><a href="{{route('Ventilation.filtre')}}"><i class="fas fa-search"></i>Filtre
                            Ventilation</a></li> --}}
                    <li><a href="{{route('Ventilation.rapport')}} "
                            class="{{request()->routeIs('Ventilation.rapport') ? 'active':''}}"><i
                                class="fas fa-print"></i>Rapport</a></li>
                </ul>
            </li>
            {{-- Livreur --}}
            <li class="submenu">
                <a href="#"><i class="fas fa-chalkboard-teacher"></i> <span>Livreur</span> <span
                        class="menu-arrow"></span></a>
                <ul>
                    <li><a href="{{route('Livreur.ajout')}}"
                            class="{{request()->routeIs('Livreur.ajout') ? 'active':''}}"><i
                                class="fas fa-plus"></i>Ajouter Livreur</a></li>
                    <li><a href="{{route('Livreur.index')}}"
                            class="{{request()->routeIs('Livreur.index') ? 'active':''}}"><i
                                class="fas fa-book"></i>Liste Livreur</a></li>
                </ul>
            </li>
            {{-- petrin --}}
            <li class="submenu">
            ...
            {{-- Paiement --}}
            <li class="submenu">
                <a href="#"><i class="fas fa-book-reader"></i> <span>Paiement</span> <span
                        class="menu-arrow"></span></a>
                <ul>
