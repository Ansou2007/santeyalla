...
<div class="header">
    ...
    <div class="media d-flex">
    <span class="avatar avatar-sm flex-shrink-0">
    <img class="avatar-img rounded-circle" alt="User Image" src="{{asset('img/profiles/avatar-11.jpg')}}">
    </span>
    <div class="media-body flex-grow-1">
    ...
    <span class="user-img">
    <img class="rounded-circle" src="{{asset('img/profiles/avatar-01.jpg')}}" width="31" alt="Soeng Souy">
    <div class="user-text">
    ...
    <a class="dropdown-item" href="{{route('Utilisateur.profil')}}"><i class="fas fa-user"></i>&nbspMon Profil</a>
    <a class="dropdown-item" href="#"><i class="fas fa-key"></i>&nbspChanger Mot de passe</a>
    {{-- Deconnexion--}}
    <form action="{{ route('logout') }}" method="post">
        @csrf
    <a class="dropdown-item" href="{{route('logout')}}" onclick="event.preventDefault();
    this.closest('form').submit();"><i class="fe fe-log-out"></i>Déconnexion</a>
    </form>
    </div>
    </li>
