    ...
    <div class="profile-header">
        <div class="row align-items-center">
            ...
            <div class="col ms-md-n2 profile-user-info">
                ...
                <h5 class="text-muted">{{$profil->role}}</h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <p class="col-sm-9">{{$profil->date_naissance}}</p>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <p class="col-sm-9"><strong>{{$profil->telephone}}</strong></p>
                            </div>
                            <div class="row">
                                <p class="col-sm-3 text-muted text-sm-end mb-0">Boulangerie</p>
                                <p class="col-sm-9 mb-0"><strong>{{$profil->structures->nom_complet}}</strong><br></p>
                            </div>
                            <div class="row">
                                <p class="col-sm-3 text-muted text-sm-end mb-0">Addresse</p>
